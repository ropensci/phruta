...
Now, we still need to retrieve the sequences from the accessions table. The `sq.retrieve.indirect` function will write all the resulting fasta files into the newly created folder `0.Sequences` located in our working directory.
