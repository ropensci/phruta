...
You may also want to check if `RAxML` is called from the console using `raxmlHPC` or `raxml`. In fact, this string is passed to the `exec` argument in `ips::raxml` when running `tree.raxml` (`raxml_exec` therein).
