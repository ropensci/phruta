...
I acknowledge that the current release of the package is limited in different ways. Next releases will focus on improving the following aspects:
  ...
  - Expand taxonomic cleaning for non-animal/plant groups (Ok)
  - Taxonomic tree constraints (Ok)
  - Partitioned analyses in RAxML (Ok)
  - PartitionFinder (V1 Ok)
  - https://github.com/ms609/Roguer/ (Ok)
